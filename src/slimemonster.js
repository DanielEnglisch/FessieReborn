...
function SlimeMonster(pos) {
  ...
  this.draw = function (context) {
    ...
    switch (this.looking) {
      case Direc.LEFT:
        context.drawImage(tex.slime_monster_left.getImage(), this.pos.x * scale + 0, this.pos.y * scale + 0, scale, scale);
        break;
      case Direc.RIGHT:
        context.drawImage(tex.slime_monster_right.getImage(), this.pos.x * scale + 0, this.pos.y * scale + 0, scale, scale);
        break;
      default:
        context.drawImage(tex.slime_monster_center.getImage(), this.pos.x * scale + 0, this.pos.y * scale + 0, scale, scale);
